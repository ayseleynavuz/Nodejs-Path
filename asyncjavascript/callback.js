...
//kod sırasına göre çalışır.
func1();
func2();

// js her zaman senkron olarak çalışır ve
// single thread çalışır -> aynı an da tek bir işlem yapar ve sıralı bir şekilde çalışır.
// js kodu manipüle edilir ve asenkron çalışıyormuş gibi davranır.
...
// kitapçı dükkanına yeni kitap eklenince listelenen kitaplar içinde olmasını isteriz.
...
const addBook = (newBook, callback) => {
    ...
    // ancak her defasinda bu degisikligin gorunmesi icin listbooks fonksiyonunun yeniden cagrilmasi gerekecekti
...
// addbook higher order function (yüksek seviyeli fonksiyon alarak tanimlanirken)
